...
private:
    const char *task_names[NUM_TASKS] = {
            ...
            "HANDLE_MQTT_MESSAGE", "LOAD_CONFIG", "SAVE_CONFIG", "LOAD_FS", "SAVE_FS", "CHECK_WIFI_CONNECTION",
            ...
            "READ_RFID_TAG", "WRITE_RFID_TAG", "SET_RFID_SCANNING_MODE", "REGISTER_RFID_TAG",
            "RESET_SCANNED_RFID_TAG_COUNT", "INSERT_DATA_ROW", "UPDATE_DATA_ROW", "DELETE_DATA_ROW",
            "SAVE_DATA_COLLECTION", "DELETE_DATA_COLLECTION", "LOAD_DATA_COLLECTION", "READ_PERIPHERAL_INPUT",
            "SEND_PERIPHERAL_OUTPUT", "START_CONVEYOR", "STOP_CONVEYOR", "SUBMIT_CHOSEN_ITEM", "TOGGLE_SOUND", "NO_TASK"
    };
    const char *feature_names[NUM_FEATURES] = {
            "BOOT", "LOADING", "QR_CODE_SCANNING", "HOME_HANDHELD_1", "HOME_HANDHELD_2", "HOME_TERMINAL", "SETTING",
            "SETTING_WIFI", "SETTING_USER_INFO", "SETTING_USER_INFO_LOGIN", "SETTING_USER_INFO_LOGOUT", "RFID",
            "RFID_SCAN", "RFID_SCAN_HISTORY", "RFID_SCAN_RESULT", "RFID_MODIFY_TAG_DATA", "RFID_REGISTER_TAG",
            "RFID_FACTORY_SELECT", "RFID_WEEK_SELECT", "RFID_MES_PACKAGES_LIST", "RFID_PACKAGE_GROUPS_LIST",
            "RFID_BUYER_PO_LIST", "RFID_SCAN_DETAILS_REVIEW", "PACKAGE", "PACKAGE_DETAILS", "CO_WORKING",
            "CO_WORKING_SCAN_NEARBY_DEVICE", "CO_WORKING_CONNECT_TO_DEVICE", "CO_WORKING_CONNECT_TO_SERVER",
            "CO_WORKING_RUNNING", "DATABASE", "DATA_IMPORT", "DATA_IMPORT_FROM_SD_CARD", "DATA_IMPORT_FROM_SERVER",
            "DATA_IMPORT_FROM_COMPUTER", "DATA_EXPORT", "DATA_EXPORT_TO_SERVER", "DATA_EXPORT_TO_SD_CARD", "DATA_SYNC",
